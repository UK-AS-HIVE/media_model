...
function media_model_viewer(objPath, mtlPath, nrmPath, fileId){
	...
	*/
	...
	function onMouseWheel( event ){
		...
		direction.subSelf( camera.position ).normalize();
	...
	function onMouseMove( event ) {
		//rotateAroundObject(camera, dy * 0.002, dx * 0.002, cursorPyr);
...
*/
	...
	function rotateAroundObject(object, dx, dy, target) {
